                ...
                <div class="card card-box mb-2 mt-2">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="content" cols="30" class="ckeditor form-control" placeholder="Enter Post content here "></textarea>
                ...
                <div class="card card-box mb-2">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input name="meta_keywords" cols="30" rows="10" class="form-control" placeholder="Enter post meta keywords" id=""></input>
                        </div>
                        <div class="form-group">
                            <label for=""><b>Post meta description</b>:</label>
                            <textarea name="meta_description"  cols="30" rows="10" class="form-control" placeholder="Enter Post meta description"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-box mb-2">
                    <div class="card-body">
                        ...
                        <div class="d-block mb-3" style="max-width: 250px" >
                            <img src="" alt="" id="feature_image_preview" style="max-width:100%" height="auto" >
                        </div>
                        <div class="form-group">
